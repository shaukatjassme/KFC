    ...
    return (
        <div className="container-fluid">
            <nav className="navbar navbar-expand-md bg-body-tertiary sticky-top">
                ...
                <button
                    className="navbar-toggler white-toggler-button"
                    type="button"
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                                ...
                                <li>
                                    <a className="dropdown-item" href="#">
                                        <div className="dropdown-content">
                                            <img
                                                src="https://s7d1.scene7.com/is/image/mcdonalds/nav_mcnuggetscombo_160x160:menu-category-desktop?resmode=sharp2"
                                                alt="Item Image"
                    ...
                    <div className="search-and-icons">
                        ...
                        <div className="user-icons d-flex mb-2">
                            ...
                            <div className="cart">
                                <button
                                    className="btn btn-primary cartview-class"
                                    type="button"
                    ...
                    <div className="contact-info d-md-flex">
                        ...
                        <p>
                            <a href="mailto:">shaukat.jassme786@gmail.com</a>
                        </p>
                    </div>
                </div>
            </nav>
